...
def interleaved_sum(n, f_odd, f_even):
    ...
    def add_up(i):
        if i > n:
            ...
            if i + 1 > n:
                return add_up(i + 2) + f_odd(i)
            else:
                return add_up(i + 2) + f_odd(i) + f_even(i + 1)
    return add_up(1)
...
def count_dollars(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    return bill_with_largest(total, 100)
    
def bill_with_largest(n, m):
    if n == 0:
        return 1
    elif n < 0:
        return 0
        ...
        return bill_with_largest(n - m, m) + bill_with_largest(n, next_smaller_dollar(m))
...
def count_dollars_upward(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    return bill_with_smallest(total, 1)

def bill_with_smallest(n, m):
    if m is None:
        return 0
    elif n < 0:
        return 0
        ...
        return bill_with_smallest(n - m, m) + bill_with_smallest(n, next_larger_dollar(m))
...
def make_anonymous_factorial():
    ...
    return (lambda x: x(x))(lambda y: lambda n: 1 if n == 0 else n * y(y)(n-1))