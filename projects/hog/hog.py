...
def boar_brawl(player_score, opponent_score):
    ...
    # print("DEBUG: oppo_tens = ", oppo_tens)
    curr_ones = player_score % 10
    diff = 3 * abs(curr_ones - oppo_tens)
    if diff:
        return diff
    return 1
    # END PROBLEM 2
...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    factor_nums = num_factors(score)
    if factor_nums == 3 or factor_nums == 4:
        score += 1
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    sim_up_score = simple_update(num_rolls, player_score, opponent_score, dice)
    sus_up_score = sus_points(sim_up_score)
    return sus_up_score
    # END PROBLEM 4
...
def play(strategy0, strategy1, update, score0=0, score1=0, dice=six_sided, goal=GOAL):
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            ...
            score0 = update(num_of_rolls, score0, score1, dice)
        else:
            num_of_rolls = strategy1(score1, score0)
            score1 = update(num_of_rolls, score1, score0, dice)
        who = 1 - who
    # END PROBLEM 5
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while score0 < goal:
        while score1 < goal:
            if strategy(score0, score1) != start:
                return False
            score1 += 1
        score0 += 1
        score1 = 0
...
def make_averaged(original_function, times_called=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def function_modified(*args):
        time = 1
        sum = 0
        while time <= times_called:
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    func = make_averaged(roll_dice, times_called)
    roll_num = 1
    ans = 0
    res = 0
    while roll_num <= 10:
        curr = func(roll_num, dice)
        if curr > res:
            ans = roll_num
            res = curr
        roll_num += 1
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    choice_0 = boar_brawl(score, opponent_score)
    if choice_0 >= threshold:
        return 0
